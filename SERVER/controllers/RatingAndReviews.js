const RatingAndReviews=require("../models/Rating")
...
exports.createRating = async (req,res)=>{
  try {
    ...
    const courseDetails= await Course.find({_id: courseId,
     ...
     const alreadyReviewed =await RatingAndReviews.findOne({user:userId,
     course:courseId});
     ...
     const ratingReview= await RatingAndReviews.create({rating:rating,
         review:review,
         course:courseId,
         user:userId});
