    ...
    <div className='md:w-[calc(100vw-320px)] w-screen p-3'>
      {
        ...
        (
          <div>
            <div className="border-4 border-grey-1 rounded-lg overflow-hidden">
                      ...
                      <div className='flex justify-center items-center'>
                        {
                          !completedLectures.includes(videoData._id) && (
                            <button onClick={handleLectureCompletion} className='bg-red-1 text-white absolute top-[20%] hover:scale-90 z-20 font-medium md:text-sm px-4 py-2 rounded-md'>Mark as Completed</button>
                          )
                        }
                      </div>
                      {
