...
const CourseCard = ({cardData,currentCard,setCurrentCard}) => {
  ...
  return (
    ...
    <div>     
    <button className={`flex flex-col  w-[360px] p-5 gap-1  ${currentCard===cardData.heading? 
      "bg-white text-richblue-900 shadow-[12px_12px_0px] shadow-red-2":"bg-grey-1 text-richblue-100"}`}
