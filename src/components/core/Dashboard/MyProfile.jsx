...
const MyProfile=()=>{
    ...
    return(
        <div className=' mx-auto w-11/12 max-w-[1000px] py-1'>
            <div className='py-10'>
        <h1 className='mx-auto mb-14 text-3xl font-medium text-richblack-5'>
            My Profile
        </h1>
        
        {/* section 1 */}
        <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-[#212121] p-3 md:p-8 md:px-12'>
        ...
        {/* section 2 */}
        <div className='my-10 flex flex-col gap-y-3 md:gap-y-10 rounded-md border-[1px] border-richblack-700 bg-[#212121] p-3 md:p-8 md:px-12'>
            ...
            <p className='text-richblack-300 text-sm font-medium'> {user?.additionalDetails?.about  ??  "Write Something about Yourself"}</p>
        </div>

        {/* section 3 */}
        <div className='my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-[#212121] p-3 md:p-8 md:px-12'>
            <div className='flex w-full items-center justify-between'>
