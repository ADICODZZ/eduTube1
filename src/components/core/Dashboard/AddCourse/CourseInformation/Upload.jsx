...
const Upload = ({name, label, register, errors, setValue}) => {
  ...
  <div className="bg-[#292828] flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-500">
    <div
    ...
    >
      ...
      <div className="grid aspect-square w-14 place-items-center rounded-full bg-pure-greys-800">
        <svg
          ...
          className="text-2xl text-[#b31c1c]"
          height="1em"
          width="1em"
      ...
      <p className="mt-2 max-w-[200px] text-center text-sm text-richblack-200">
        ...
        <span className="font-semibold text-[#c42323]">Browse</span> a file
      </p>
