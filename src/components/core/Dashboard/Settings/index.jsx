  ...
  return (
    <div>
      <div className=' flex-1 overflow-auto'>
        ...
        {/* update profile picture */}
        <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-grey-1 md:p-8 md:px-12 px-3 py-3 text-richblack-5'>
          <div className='flex items-center gap-x-4'>
            ...
            <input id='upload' type="file" onChange={handleFileChange} className="hidden" accept="image/png, image/gif, image/jpeg"/></label>
             <button type='submit' className='flex items-center bg-red-1 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-white undefined'>Upload</button>
            </div>
            </form>
            </div>
          </div>
        ...
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-grey-1 p-8 px-12">
          ...
          <div className="flex justify-end gap-2"><button className="flex items-center bg-red-1 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900 undefined" type="submit">Save</button></div>
          </form>
          ...
          <div >
                                <div className=' relative mt-4'>
                                    ...
                                    <input
                                       ...
                                       className="w-full rounded-[0.5rem] bg-grey-1 p-[12px] pr-12 text-richblack-5"
                                     /></label>
                                     <span
                                ...
                                <div className="flex justify-end gap-2 mt-3"><button className="flex items-center bg-red-1 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-white undefined" type="submit">Save</button></div>
                                </form>
