...
const NavBar = ({ setProgress }) => {
    ...
    return (
        <div className={` flex sm:relative bg-black-1 w-screen relative z-50 h-14 items-center justify-center border-b-[1px] border-b-richblack-700 translate-y-  transition-all duration-500`}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                ...
                <div className={`flex md:hidden  relative gap- flex-row ${token !== null && user?.accountType !== "Instructor" ? " -left-12" : ""}`}>
                    <GiHamburgerMenu className={`w-16 h-8 fill-richblack-25 absolute left-10 -bottom-4 hover:cursor-pointer`} onClick={shownav} />
                ...
                {/* Desktop Navbar */}
                <nav>
                    <ul className=' flex-row gap-x-6 bg-black-1 text-richblack-25 gap-5 hidden md:flex'>
                        {
