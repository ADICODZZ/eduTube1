...
const About=()=>{
    return (
        <div className='mt-[100px] text-white'>
            ...
            <section className='bg-richblack-700'>
                <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                    <header  className='mx-auto py-20 text-3xl font-semibold lg:w-[70%]'>
                        ...
                        EduTube is at the forefront of driving innovation in online education. 
            ...
            {/**/ }
            <section className = 'mx-auto p-8 flex flex-col items-center justify-between gap-5 mb-[140px]'>
                <LearningGrid/>
                <ContactFormSection />
